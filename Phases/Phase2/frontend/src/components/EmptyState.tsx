...
export default function EmptyState({ filter, onAddTask }: EmptyStateProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      {/* Illustration */}
      <div className="w-48 h-48 mb-6 text-gray-200" aria-hidden="true">
        <svg viewBox="0 0 200 200" fill="currentColor">
          <rect x="30" y="40" width="140" height="120" rx="8" fill="currentColor" />
          <rect x="45" y="60" width="80" height="8" rx="4" fill="#e5e7eb" />
          <rect x="45" y="80" width="110" height="6" rx="3" fill="#e5e7eb" />
          <rect x="45" y="95" width="90" height="6" rx="3" fill="#e5e7eb" />
          <circle cx="160" cy="64" r="8" fill="#3b82f6" opacity="0.3" />
          <rect x="45" y="120" width="70" height="8" rx="4" fill="#e5e7eb" />
          <rect x="45" y="138" width="100" height="6" rx="3" fill="#e5e7eb" />
          <circle cx="160" cy="124" r="8" fill="#22c55e" opacity="0.3" />
        </svg>
      </div>
